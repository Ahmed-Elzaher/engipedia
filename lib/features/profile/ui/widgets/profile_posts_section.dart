        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _buildAuthorRow(
                    "Dr. Sarah Ibrahim", "Professor of Computer Architecture"),
                SizedBox(height: 12.h),
                Text("New findings in RISC-V optimization",
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image: AssetImage('assets/images/cpu_arch.png'),
                        fit: BoxFit.cover),
                  ),
                ),
              ],
      ...
      children: [
        Container(
          ...
          decoration: const BoxDecoration(
              color: Color(0xFFD6DAF5), shape: BoxShape.circle),
  ...
  Widget _buildAuthorRow(String name, String title) {
    return Row(
      children: [
        const CircleAvatar(
            radius: 16,
            backgroundImage: AssetImage('assets/images/dr_sarah.png')),
        SizedBox(width: 12.w),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Text(title,
                style: AppStyles.smallRegular10.copyWith(fontSize: 11.sp)),
          ],
        ),
      ],
    );
  ...
  Widget _buildActionItem(IconData icon, String count, {bool isShare = false}) {
    return Row(
      children: [
        Icon(icon,
            size: 18.sp,
            color: isShare ? const Color(0xFF2563EB) : const Color(0xFF1349EC)),
        SizedBox(width: 8.w),
        Text(count,
            style: AppStyles.smallRegular10
                .copyWith(fontSize: 13.sp, color: const Color(0xFF141C52))),
      ],
    );
  }
}
